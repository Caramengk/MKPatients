...
{
    public class PatientsMKController : Controller
    {
        private readonly PatientsContext _context;

        public PatientsMKController(PatientsContext context)
        {
            _context = context;
        }
